...
<body>
    ...
    <div class="verify-box">
        ...
        <form action="../../controllers/AuthController.php" method="POST" id="otp-form">
        ...
        <div class="resend">
            Vous n'avez rien reçu ? <a href="../../controllers/AuthController.php?action=resend_otp">Renvoyer le code</a>
        </div>
