...
/**
 * DonAIService — Calls external Ollama LLM to rank campaign urgency.
 * Renamed from AIService to avoid ambiguity with root AiFeaturesController.
 */
class DonAIService
{
    ...
    public function __construct(
        ...
        $this->endpoint = $endpoint !== '' ? $endpoint : (defined('OLLAMA_URL') ? OLLAMA_URL : 'http://51.83.4.21:11434/api/generate');
        $this->model    = $model;
    }
