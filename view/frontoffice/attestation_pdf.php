...
<body>
    ...
    <div class="page">
        ...
        <div class="content">
            <p>La banque <strong>LegalFin Bank</strong> certifie par la présente l'émission du chèque référencé ci-dessous, rattaché au chéquier n° <strong><?= htmlspecialchars($chequier['numero_chequier']) ?></strong> au nom de <strong><?= htmlspecialchars($chequier['nom et prenom'] ?? 'Client') ?></strong>.</p>
        ...
        <div class="footer">
            <div class="signature-box">
                ...
                <div class="detail-val"><?= htmlspecialchars($chequier['nom et prenom'] ?? 'Client') ?></div>
            </div>
            <div class="signature-box">
    ...
    <script>
        ...
        window.onload = function() {
            setTimeout(function() {
                // window.print(); // On laisse l'utilisateur cliquer sur le bouton pour plus de contrôle
            }, 500);
        };
    </script>
</body>
...
<?php 
// Pas besoin de fermer la balise PHP si c'est la fin du fichier, mais c'est propre
?>
