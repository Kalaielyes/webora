...
function editCheque(idCheque) {
  ...
  openChequeModal(numChequier, chq.beneficiaire, chq.rib_beneficiaire, chq.id_chequier);
  setTimeout(() => {
    document.querySelector('.modal-title').textContent = "Modifier un chèque";
    document.getElementById('chkId').value = "CHK-MOD-" + chq.id_cheque;
    document.getElementById('chkNmr').value = chq.numero_cheque;
    document.getElementById('chkMontant').value = chq.montant;
    document.getElementById('chkDate').value = chq.date_emission;
    document.getElementById('chkLettres').value = chq.lettres;
    document.getElementById('chkAgence').value = chq.agence;
    document.getElementById('chkBenef').value = chq.beneficiaire;
    document.getElementById('chkCin').value = chq.cin_beneficiaire;
    document.getElementById('chkRib').value = chq.rib_beneficiaire;
    const form = document.getElementById('chequeEmissionForm');
    form.querySelector('input[name="action_type"]').value = 'update_cheque';
