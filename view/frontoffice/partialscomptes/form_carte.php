  <div class="section-head" style="margin-bottom:.3rem">
    ...
    <a href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php<?= $selected?'?id_compte='.$selected->getIdCompte():'' ?>" class="btn-ghost">✕ Annuler</a>
  </div>
  <div class="demand-card">
    ...
    <form id="form_carte" method="POST" action="<?= APP_URL ?>/controller/CarteController.php">
      ...
      <div class="form-grid">
        <div class="form-field">
          ...
          <div style="font-size:.7rem;color:var(--rose);margin-top:.3rem">⚠ Aucun compte disponible. <a href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php?form=compte" style="color:var(--blue)">Ouvrir un compte d'abord.</a></div>
          <?php endif; ?>
        </div>
        <div class="form-field">
