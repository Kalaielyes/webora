  ...
  <div class="attente-section">
    ...
    <div class="attente-item">
      ...
      <div class="attente-info">
        ...
        <div class="attente-meta">IBAN: <span class="privacy-blur"><?= htmlspecialchars(substr($c->getIban(),0,16)).'...' ?></span></div>
      </div>
  ...
  <div class="attente-section" style="border-color:rgba(79,142,247,.2)">
    ...
    <div class="attente-item">
      ...
      <div class="attente-info">
        <div class="attente-label"><?= htmlspecialchars(ucfirst($carte->getTypeCarte())) ?> <?= strtoupper($carte->getReseau()) ?> — <span class="privacy-blur"><?= htmlspecialchars($carte->getNumeroCarte()) ?></span></div>
