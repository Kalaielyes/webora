        ...
        <div class="prj-grid">
            ...
            <div class="prj-card" style="border-top: 4px solid <?= $accent ?>;">
                <div class="card-head">
                    ...
                    <form action="<?= APP_URL ?>/controller/ObjectifController.php" method="POST" onsubmit="return confirm('Supprimer cet objectif ?')">
                ...
                <div class="card-foot">
                    ...
                    <?php if (!$isAtteint): ?>
                        <?php if ($isKycVerifie): ?>
                        <a class="btn-ghost" style="padding: 6px 12px; font-size: 0.7rem; font-weight: 700; color: var(--blue); border-color: var(--blue-border); text-decoration: none; display: inline-block;" href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php?form=virement&dest_type=objectif&id_objectif=<?= $obj->getIdObjectif() ?>">
                            VERSER
                        </a>
                        <?php else: ?>
...
<div id="modal-obj" class="prj-modal">
    <div class="modal-content">
        ...
        <form action="<?= APP_URL ?>/controller/ObjectifController.php" method="POST" class="prj-form">
            <?php Security::csrfInput(); ?>
