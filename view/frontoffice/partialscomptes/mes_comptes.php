  ...
  <div class="accounts-switcher">
    ...
    <a href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php?id_compte=<?= $c->getIdCompte() ?>"
  ...
  <div class="balance-card">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.6rem;margin-top:.85rem;padding-top:.8rem;border-top:1px solid var(--border)">
      ...
      <div style="display:flex;gap:.5rem;flex-wrap:wrap">
        ...
        <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:contents">
  ...
  <div>
    <div class="section-head" style="margin-bottom:.9rem">
      ...
      <?php if ($selected->getStatut()==='actif'): ?>
        <?php if ($isKycVerifie): ?>
        <a href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php?form=carte&id_compte=<?= $selected->getIdCompte() ?>" class="btn-ghost">
    ...
    <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--r);padding:2rem 1.5rem;text-align:center;color:var(--muted)">
      ...
      <?php if ($selected->getStatut()==='actif'): ?>
        <?php if ($isKycVerifie): ?>
        <a href="<?= APP_URL ?>/view/frontoffice/frontoffice_compte.php?form=carte&id_compte=<?= $selected->getIdCompte() ?>" class="btn-primary">Demander une carte</a>
        <?php else: ?>
      ...
      <div class="carte-card">
        ...
        <div class="card-info-section">
          ...
          <div class="carte-actions-row" style="margin-top:.8rem;">
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="width:100%;">
              <?php Security::csrfInput(); ?>
