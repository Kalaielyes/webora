...
<script>
  (function(){
    ...
    if (localStorage.getItem('privacy') === 'true') {
      localStorage.setItem('privacy_mode', 'hidden');
...
<link rel="stylesheet" href="<?= APP_URL ?>/view/assets/css/frontoffice/cagnotte.css">
    ...
    <div class="content">
      <div class="hero-row">
        ...
        <div class="hero-card">
          ...
          <div class="hc-val privacy-blur"><?= number_format($totalCollectedMy,2,',',' ') ?><span>€</span></div>
        ...
        <div class="hero-card">
          ...
          <div class="hc-val privacy-blur"><?= number_format($mesDonsTotal,2,',',' ') ?><span>€</span></div>
        ...
        <div class="stat-mini">
          ...
          <div class="sm-sub privacy-blur">Total : <?= number_format($mesDonsTotal,2,',',' ') ?> €</div>
        </div>
        <?php if ($currentUserIsAssociation): ?>
        <div class="stat-mini">
        ...
        ?>
          <div class="cagnotte-card" onclick="openDon(<?= (int)$c['id_cagnotte'] ?>,'<?= htmlspecialchars(addslashes($c['titre'])) ?>')">
            ...
            <div class="cc-body">
              ...
              <div class="cc-amounts privacy-blur"><span class="cc-collected"><?=number_format($collected,2,',',' ')?> €</span><span class="cc-goal">/ <?=number_format($objectif,0,',',' ')?> €</span></div>
            ...
            <?php else: foreach (array_slice($userDons,0,6) as $ud): ?>
              <div class="don-item">
                ...
                <div style="display:flex;flex-direction:column;align-items:flex-end;gap:.25rem;">
                  ...
                  ?>
                  <div><div class="don-amount privacy-blur">+ <?=number_format($ud['montant'],2,',',' ')?> €</div><div class="don-status <?= htmlspecialchars($donStatusClass) ?>"><?= htmlspecialchars($donStatusLabel) ?></div></div>
                  <form method="post" style="display:inline;margin:0;padding:0;">
