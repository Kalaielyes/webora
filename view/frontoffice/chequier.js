/**
 * Gestion des interactions et validation du formulaire chéquiers (Front Office)
 */

// 1. Initialisation : Masquer le message de succès PHP après 5 secondes
...
/* fermer au clic sur l'overlay (hors modal-box) */
...
function submitCheque() {
  ...
  // We do a simple check to ensure date format is somehow provided.
  if (!date) {
  ...
  /* Ici : envoyer les données au serveur (fetch/AJAX ou submit) */
