...
$ALL_MODULES = [
    ...
    'chequiers'        => ['label'=>'Chéquiers',        'icon'=>'<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>', 'color'=>'var(--primary)'],
];
$notifications = [];
      ...
      <div>
        <div class="profile-card">
          <div class="profile-avatar">
            <?php if (!empty($currentUser['selfie_path']) && file_exists(__DIR__ . '/../../' . $currentUser['selfie_path'])): ?>
                <img src="<?= APP_URL ?>/<?= htmlspecialchars($currentUser['selfie_path']) ?>" onerror="this.style.display='none'">
            <?php endif; ?>
            <span class="profile-avatar-initials"><?= $adminInitials ?></span>
          </div>
          <div>
