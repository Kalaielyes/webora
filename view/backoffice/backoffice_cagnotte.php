          ...
          <div class="admin-filters-grid compact-filters">
            <div class="filter-block">
              ...
              <?php foreach ($statusOptions as $statusValue => $statusLabel): ?>
                ...
                ?>
                <a class="filter-btn filter-chip <?= $cagFilters['status'] === $statusValue ? 'active' : '' ?>" href="<?= backofficeBuildUrl('backoffice_cagnotte.php', $statusParams) ?>"><?= htmlspecialchars($statusLabel) ?></a>
              <?php endforeach; ?>
            </div>
            </div>
            <div class="filter-block">
              ...
              <div class="filters filters-links filter-chip-group">
                <?php foreach ($categoryOptions as $categoryValue => $categoryLabel): ?>
                  ...
                  ?>
                  <a class="filter-btn filter-chip <?= $cagFilters['category'] === $categoryValue ? 'active' : '' ?>" href="<?= backofficeBuildUrl('backoffice_cagnotte.php', $categoryParams) ?>"><?= htmlspecialchars($categoryLabel) ?></a>
                <?php endforeach; ?>
              </div>
            </div>
            <div class="filter-actions-row">
              <a class="btn-ghost" href="<?= backofficeBuildUrl('backoffice_cagnotte.php') ?>">Réinitialiser</a>
            </div>
          </div>
        </div>
