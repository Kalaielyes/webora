...
<div class="main">
  <div class="topbar">
    ...
    <div class="tb-right">
      <a class="btn-ghost" href="<?= backofficeBuildUrl('backoffice_cagnotte.php') ?>">Ouvrir les cagnottes</a>
      <a class="btn-primary" href="<?= backofficeBuildUrl('backoffice_don.php') ?>">Ouvrir les dons</a>
    </div>
  </div>
