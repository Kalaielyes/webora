      ...
      <tr>
        ...
        <td>
          <div class="action-group">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Voulez-vous supprimer cette demande ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Accepter la clôture ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Refuser la demande de clôture ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Accepter la suppression définitive ?')">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="delete">
              <input type="hidden" name="id_compte" value="<?= $row['id_compte'] ?>">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Accepter la conversion en compte courant ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CompteController.php" style="display:inline" onsubmit="return confirm('Refuser la demande d\'activation ?')">
              <?php Security::csrfInput(); ?>
      ...
      <tr>
        ...
        <td>
          <div class="action-group">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="activer">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Voulez-vous supprimer cette demande ?')">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="delete">
              <input type="hidden" name="id_carte" value="<?= $carte->getIdCarte() ?>">
              <input type="hidden" name="redirect_id_compte" value="<?= $carte->getIdCompte() ?>">
            ...
            <a href="<?= APP_URL ?>/view/backoffice/backoffice_compte.php?tab=comptes&id_compte=<?= $carte->getIdCompte() ?>" class="act-btn" title="Voir détail du compte">
              <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
            </a>
            <?php endif; ?>
            <?php if ($carte->getStatut()==='demande_blocage'): ?>
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Accepter et bloquer cette carte ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Refuser la demande de blocage ?')">
              <?php Security::csrfInput(); ?>
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Accepter la suppression de cette carte ?')">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="delete">
              <input type="hidden" name="id_carte" value="<?= $carte->getIdCarte() ?>">
              <input type="hidden" name="redirect_id_compte" value="<?= $carte->getIdCompte() ?>">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Refuser la demande de suppression ?')">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="refuser_cloture">
              <input type="hidden" name="id_carte" value="<?= $carte->getIdCarte() ?>">
              <input type="hidden" name="redirect_id_compte" value="<?= $carte->getIdCompte() ?>">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Réactiver cette carte ?')">
              <?php Security::csrfInput(); ?>
              <input type="hidden" name="action" value="activer">
              <input type="hidden" name="id_carte" value="<?= $carte->getIdCarte() ?>">
              <input type="hidden" name="redirect_id_compte" value="<?= $carte->getIdCompte() ?>">
            ...
            <form method="POST" action="<?= APP_URL ?>/controller/CarteController.php" style="display:inline" onsubmit="return confirm('Refuser la réactivation ?')">
              <?php Security::csrfInput(); ?>
