...
require_once __DIR__ . "/backoffice_helpers.php";
...
<div class="main">
  <div class="topbar">
    ...
    <div class="tb-right">
      ...
      <a class="btn-ghost" href="<?= backofficeBuildUrl('backoffice_stats.php') ?>">Voir les statistiques</a>
    </div>
  </div>
        ...
        <div class="admin-filters-grid admin-filters-grid-wide compact-filters">
          <div class="filter-block">
            ...
            <div class="filters filters-links filter-chip-group">
              <?php foreach ($statusOptions as $value => $label): ?>
                ...
                ?>
                <a class="filter-btn filter-chip <?= $donFilters['status'] === $value ? 'active' : '' ?>" href="<?= backofficeBuildUrl('backoffice_don.php', $statusParams) ?>"><?= htmlspecialchars($label) ?></a>
              <?php endforeach; ?>
            </div>
          </div>
          ...
          <div class="filter-block">
            ...
            <div class="filters filters-links filter-chip-group">
              <?php foreach ($paymentOptions as $value => $label): ?>
                ...
                ?>
                <a class="filter-btn filter-chip <?= $donFilters['payment_method'] === $value ? 'active' : '' ?>" href="<?= backofficeBuildUrl('backoffice_don.php', $paymentParams) ?>"><?= htmlspecialchars($label) ?></a>
              <?php endforeach; ?>
            </div>
          </div>
          ...
          <form method="get" class="admin-filters-grid admin-filters-grid-wide date-filter-form">
            ...
            <div class="filter-actions-row">
              ...
              <a class="btn-ghost" href="<?= backofficeBuildUrl('backoffice_don.php') ?>">Réinitialiser</a>
            </div>
          </form>
        </div>
      </div>
