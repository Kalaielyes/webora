...
<div class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <div class="nav-dropdown <?= ($currentFile_sidebar === "backoffice_chequier.php" || $currentFile_sidebar === "chequier_statistiques.php") ? "open" : "" ?>" id="dropdown-chequier-admin">
      ...
      <div class="nav-dropdown-menu">
        <a class="nav-sub-item <?= ($currentFile_sidebar === "backoffice_chequier.php" && ($action ?? '') === "chequiers")?"active":"" ?>" href="backoffice_chequier.php?action=chequiers">
          <span class="nav-sub-dot"></span>Liste des chéquiers
        </a>
        <a class="nav-sub-item <?= ($currentFile_sidebar === "backoffice_chequier.php" && ($action ?? '') === "demandes")?"active":"" ?>" href="backoffice_chequier.php?action=demandes">
          <span class="nav-sub-dot"></span>Demandes
        </a>
        <a class="nav-sub-item <?= ($currentFile_sidebar === "chequier_statistiques.php")?"active":"" ?>" href="chequier_statistiques.php">
