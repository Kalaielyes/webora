...
$selected = null;
$cartes   = [];
if (isset($_GET['id_compte']) && $_GET['id_compte'] !== '') {
...
$editCarte  = (isset($_GET['edit_carte']) && $_GET['edit_carte'] !== '');
$carteEdit  = null;
if ($editCarte) {
...
<link rel="stylesheet" href="<?= APP_URL ?>/view/assets/css/backoffice/compte.css">
<script>
  (function() {
...
<div class="main">
  <div class="topbar">
    ...
    <div class="topbar-right" style="display:flex;align-items:center;gap:1rem">
      <?php if ($tab==='comptes'): ?>
      <div class="search-bar" style="margin-right: 0.5rem; display:flex; align-items:center; background:var(--bg3); border:1px solid var(--border); border-radius:8px; padding:0 .8rem; height:36px; gap:.6rem">
        <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
        <input placeholder="Rechercher IBAN, nom…" id="search-input" oninput="applyFilters()" style="background:none; border:none; color:var(--text); font-size:.8rem; outline:none; width:180px;"/>
      </div>
      <?php endif; ?>
