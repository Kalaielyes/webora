    ...
    public static function handleRequest(): void {
        ...
        if ($action === 'add_objectif') {
            ...
            if (!$titre || $montant <= 0 || !$debut || !$fin) {
                ...
                header('Location: ' . APP_URL . '/views/frontoffice/frontoffice_compte.php?tab=objectifs');
                exit;
            }

            $obj = new ObjectifFinancier(0, $userId, null, $titre, $montant, 0, $devise, $debut, $fin);
            if (self::save($obj)) {
                header('Location: ' . APP_URL . '/views/frontoffice/frontoffice_compte.php?tab=objectifs&ok=1');
            } else {
        ...
        if ($action === 'delete_objectif') {
            ...
            if ($res) {
                header('Location: ' . APP_URL . '/views/frontoffice/frontoffice_compte.php?tab=objectifs&ok=deleted');
            } else {
